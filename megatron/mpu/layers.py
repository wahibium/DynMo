...
class LinearWithGradAccumulationAndAsyncCommunication(torch.autograd.Function):
    ...
    def backward(ctx, grad_output):
        ...
        # Mine
        grad_bias = torch.zeros_like(grad_bias) if use_bias else None
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        bias = torch.zeros_like(self.bias) if not self.skip_bias_add else None
        ...
        output_bias = torch.zeros_like(self.bias) if self.skip_bias_add else None

        #print(f'ColumnParallel skip_bias_add: {self.skip_bias_add} self.bias: {self.bias}, output_bias: {output_bias}')
...
class RowParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        if not self.skip_bias_add:
            ...
            output = output_
            output_bias = torch.zeros_like(self.bias)
    
        #print(f'RowParallel skip_bias_add: {self.skip_bias_add} self.bias: {self.bias}, output_bias: {output_bias}')
        return output, output_bias
