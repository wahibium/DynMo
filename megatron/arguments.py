...
def parse_args(extra_args_provider=None, ignore_unknown_args=False):
    ...
    #args.local_rank = int(os.getenv('OMPI_COMM_WORLD_RANK', '0'))
...
def _add_training_args(parser):
    ...
    ### Mine Start ###
    group.add_argument('--sparsify', action='store_true',
                        help='Sparsify the model')
    group.add_argument('--pruning-type', default='gradual', help='Pruning type')
    group.add_argument('--load-balance', action='store_true', help='Balance the loads after pruning')
    group.add_argument('--balancer', default='deepspeed', help='Balancer type', type=str,
                        choices=['deepspeed_static', 'deepspeed', 'deepspeed_param', 'diffusion', 'diffusion_param'])

    group.add_argument('--final-sparsity', type=float, default=0.9)
    group.add_argument('--pruning-start-iter', type=int, default=2)
    group.add_argument('--pruning-end-iter', type=int, default=10)
    group.add_argument('--pruning-freq', type=int, default=2)

    group.add_argument('--packing', action='store_true', help='Pack layers into fewer GPUs')
    group.add_argument('--packed-num-gpus', default=2, type=int, help='Number of GPUs to pack into')
    ##################
